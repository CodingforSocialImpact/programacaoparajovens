...
* Princípios básicos de eletrónica e montar um sistema eletrónico simples, com recurso a uma Breadboard, LEDs e resistências
...
|Raspberry Pi |1 |35€ |
|Breadboard |1 |2,5€ |
|Fios de ligação |4 |0.5€ |
|LED |1 |0.1€ |
|Resitência 1kΩ |1 |0.1€ |
