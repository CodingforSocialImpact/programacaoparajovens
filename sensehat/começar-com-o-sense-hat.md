...
1. Click **File** -- **Save As**, give your program a name e.g. [`rainbow.py`](https://www.raspberrypi.org/learning/getting-started-with-the-sense-hat/code/rainbow.py), then press **F5** to run.
